...
function MoxSwitchAccessory(platform, accessoryData)
{
    ...
    this.client.addListener('status-' + this.id, function(response, value) {
        this._log("MoxSwitchAccessory", "Received status from global event = " + value);
    ...
    this.client.receiveLightStatus(this.moduleId, this.channelId, function(response, value) {
        this._status = value;
        this._log("MoxSwitchAccessory", "Receieved initial status: " + value);
    }.bind(this));
};
...
MoxSwitchAccessory.prototype.getState = function(callback, context) {
   /* We need to return the control state in a short time otherwise
    ...
    var returnDefaultCallback = setTimeout(function() {
        ...
        /* Return the value */
        this._log("MoxSwitchAccessory", "getState(cache) = " + this._status);
    ...
    this.client.receiveLightStatus(this.moduleId, this.channelId, function(response, value) {
        ...
        /* Return the value */
        this._log("MoxSwitchAccessory", "getState = " + value);
